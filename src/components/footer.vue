      ...
      <div class="columns">
        <div class="column is-4">
          <div class="footer__widget">
            ...
            <p>Address: 17 october lakhdaria</p>
            <p>Phone: +213 791.43.69.26</p>
            <p>Email: hello@Aladdin.com</p>
          </div>
        </div>
        <div class="column is-4">
          <div class="footer__widget">
        ...
        <div class="column is-4">
          <div class="footer__widget">
            ...
            <div >
              ...
              <button type="submit" class="site-btn" onclick="javascript:void(0);">Subscribe</button>
            </div>
          ...
          <div class="footer__copyright">
            <div class="footer__copyright__text">
              <p>
                ...
                <a href="#" target="_blank">Aladdin</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
            </div>
...
.footer__widget div input::placeholder {
  color: #1c1c1c;
}

.footer__widget div button {
